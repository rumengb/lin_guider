...
bool params::load( void )
{
 ...
 bool ok;
	...
	settings.beginGroup("math");
		...
		m_math_in_params.enabled[RA] = settings.value( "enabled_RA", true ).toBool();
		m_math_in_params.enabled[DEC] = settings.value( "enabled_DEC", true ).toBool();
...
bool params::save( void )
{
 ...
 QSettings settings("GM_software", "lin-guider");
	...
	settings.beginGroup( "math" );
		...
		settings.setValue( "enabled_RA", m_math_in_params.enabled[RA] );
		settings.setValue( "enabled_DEC", m_math_in_params.enabled[DEC] );
